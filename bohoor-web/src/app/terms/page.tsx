      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <aside className="lg:col-span-4 sticky top-24 space-y-5">
            ...
            <div className="bg-amber-500/10 border border-amber-300/80 p-5 rounded-3xl space-y-2.5 text-amber-950">
            ...
            <div className="bg-gradient-to-br from-primary to-[#1f4287] text-white p-5 rounded-3xl shadow-sm space-y-3">
              ...
              <div className="pt-2 border-t border-white/10 space-y-2 text-xs">
                <a href="mailto:legal@buhoor.com.eg" className="flex items-center gap-2 text-gray-200 hover:text-white transition">
          ...
          <main className="lg:col-span-8 bg-white p-6 md:p-10 rounded-3xl border border-gray-200/80 shadow-xs space-y-10 text-gray-700 leading-relaxed text-sm md:text-base">
            ...
            <section id="investment-disclaimer" className="scroll-mt-24 space-y-4">
              <h2 className="text-xl font-black text-gray-900 font-cairo flex items-center gap-2 border-b pb-3">
                ...
                <span>إخلاء مسؤولية حاسبات العائد الاستثماري (Investment & ROI Disclaimer)</span>
              </h2>
              
              <div className="bg-gradient-to-br from-amber-50 via-orange-50 to-amber-50 p-5 rounded-2xl border border-amber-200 text-amber-950 space-y-3">
                <div className="flex items-center gap-2 font-extrabold text-sm md:text-base text-amber-900">
                ...
                <div className="bg-white/80 p-3.5 rounded-xl border border-amber-200/80 text-xs font-semibold text-amber-900 space-y-1.5">
            ...
            <section id="modifications" className="scroll-mt-24 space-y-4 pt-2">
              ...
              <div className="bg-gray-50 p-5 rounded-2xl border border-gray-200/80 space-y-2 text-sm">
                ...
                <p>الدائرة القانونية: <a href="mailto:legal@buhoor.com.eg" className="text-primary font-bold hover:underline">legal@buhoor.com.eg</a></p>
