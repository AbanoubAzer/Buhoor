...
async function main() {
  ...
  const developerUnits: any[] = [
    // سوديك ويست
    { title: 'فيلا كورنر في سوديك ويست – تقسيط 10 سنوات',     sellerType: SellerType.DEVELOPER, developerId: devSodic.id,        projectId: projSodicWest.id,   locationId: locZayed.id,     unitTypeId: typeVilla.id,       area: 380, floor: null, bedrooms: 5, bathrooms: 5, finishingStatus: 'نصف تشطيب',       isCashOnly: false, cashDiscountPercentage: 12, originalContractPrice: 18000000, cashPaidToSeller: 1800000, remainingInstallments: 16200000, monthlyEquivalentInstallment: 135000,  contractYear: 2024, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2028, coverImage: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=600', status: UnitStatus.APPROVED },
    { title: 'تاون هاوس في سوديك ويست – موقع متميز',           sellerType: SellerType.DEVELOPER, developerId: devSodic.id,        projectId: projSodicWest.id,   locationId: locZayed.id,     unitTypeId: typeTownhouse.id,   area: 250, floor: null, bedrooms: 4, bathrooms: 3, finishingStatus: 'نصف تشطيب',       isCashOnly: false, cashDiscountPercentage: 10, originalContractPrice: 11000000, cashPaidToSeller: 1100000, remainingInstallments: 9900000,  monthlyEquivalentInstallment: 82500,   contractYear: 2024, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2027, coverImage: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?q=80&w=600', status: UnitStatus.APPROVED },

    // سوديك إيست
    { title: 'شقة 3 غرف في سوديك إيست – دور مرتفع',            sellerType: SellerType.DEVELOPER, developerId: devSodic.id,        projectId: projSodicEast.id,   locationId: locTajammu.id,   unitTypeId: typeApt.id,         area: 175, floor: 5,    bedrooms: 3, bathrooms: 2, finishingStatus: 'تشطيب كامل',       isCashOnly: false, cashDiscountPercentage:  8, originalContractPrice:  8500000, cashPaidToSeller:  850000, remainingInstallments:  7650000, monthlyEquivalentInstallment:  63750,  contractYear: 2024, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2026, coverImage: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=600', status: UnitStatus.APPROVED },
    { title: 'دوبلكس في سوديك إيست – واجهة حديقة',             sellerType: SellerType.DEVELOPER, developerId: devSodic.id,        projectId: projSodicEast.id,   locationId: locTajammu.id,   unitTypeId: typeDuplex.id,      area: 220, floor: 2,    bedrooms: 4, bathrooms: 3, finishingStatus: 'تشطيب كامل',       isCashOnly: false, cashDiscountPercentage:  9, originalContractPrice: 13000000, cashPaidToSeller: 1950000, remainingInstallments: 11050000, monthlyEquivalentInstallment:  92083,  contractYear: 2023, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2025, coverImage: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?q=80&w=600', status: UnitStatus.APPROVED },

    // إعمار – ميراس
    { title: 'بنتهاوس ميراس – إطلالة بانورامية',                sellerType: SellerType.DEVELOPER, developerId: devEmaar.id,        projectId: projEmaarMireas.id, locationId: locAdm.id,       unitTypeId: typePenthouse.id,   area: 310, floor: 14,   bedrooms: 4, bathrooms: 4, finishingStatus: 'سوبر لوكس',        isCashOnly: false, cashDiscountPercentage: 12, originalContractPrice: 26000000, cashPaidToSeller: 5200000, remainingInstallments: 20800000, monthlyEquivalentInstallment: 173333,  contractYear: 2024, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2026, coverImage: 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?q=80&w=600', status: UnitStatus.PENDING_REVIEW },
    { title: 'دوبلكس فاخر ميراس – 4 غرف',                     sellerType: SellerType.DEVELOPER, developerId: devEmaar.id,        projectId: projEmaarMireas.id, locationId: locAdm.id,       unitTypeId: typeDuplex.id,      area: 280, floor: 6,    bedrooms: 4, bathrooms: 3, finishingStatus: 'تشطيب كامل',       isCashOnly: false, cashDiscountPercentage: 12, originalContractPrice: 12000000, cashPaidToSeller: 2400000, remainingInstallments:  9600000, monthlyEquivalentInstallment: 100000,  contractYear: 2023, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2025, coverImage: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=600', status: UnitStatus.APPROVED },

    // إعمار – أبتاون
    { title: 'شقة استوديو في أبتاون – استثمار مثالي',           sellerType: SellerType.DEVELOPER, developerId: devEmaar.id,        projectId: projEmaarUptown.id, locationId: locNewCairo.id,  unitTypeId: typeStudio.id,      area:  60, floor: 8,    bedrooms: 1, bathrooms: 1, finishingStatus: 'تشطيب كامل',       isCashOnly: false, cashDiscountPercentage:  7, originalContractPrice:  4200000, cashPaidToSeller:  630000, remainingInstallments:  3570000, monthlyEquivalentInstallment:  29750,  contractYear: 2024, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2027, coverImage: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?q=80&w=600', status: UnitStatus.APPROVED },

    // أوراسكوم – الجونة
    { title: 'شاليه فيو البحر – الجونة',                        sellerType: SellerType.DEVELOPER, developerId: devOrascom.id,      projectId: projGouna.id,       locationId: locGouna.id,     unitTypeId: typeChalet.id,      area: 130, floor: 1,    bedrooms: 2, bathrooms: 2, finishingStatus: 'تشطيب كامل',       isCashOnly: false, cashDiscountPercentage:  5, originalContractPrice:  7000000, cashPaidToSeller:  700000, remainingInstallments:  6300000, monthlyEquivalentInstallment:  52500,  contractYear: 2024, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2024, coverImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=600', status: UnitStatus.APPROVED },
    { title: 'توين هاوس في الجونة – حي البحيرات',              sellerType: SellerType.DEVELOPER, developerId: devOrascom.id,      projectId: projGouna.id,       locationId: locGouna.id,     unitTypeId: typeTwin.id,        area: 200, floor: null, bedrooms: 3, bathrooms: 3, finishingStatus: 'نصف تشطيب',       isCashOnly: false, cashDiscountPercentage:  8, originalContractPrice: 10000000, cashPaidToSeller: 2000000, remainingInstallments:  8000000, monthlyEquivalentInstallment:  66666,  contractYear: 2023, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2024, coverImage: 'https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?q=80&w=600', status: UnitStatus.APPROVED },

    // أوراسكوم – مكادي
    { title: 'شاليه في مكادي هايتس – إطلالة أمامية',           sellerType: SellerType.DEVELOPER, developerId: devOrascom.id,      projectId: projMakadi.id,      locationId: locHurghada.id,  unitTypeId: typeChalet.id,      area: 100, floor: null, bedrooms: 2, bathrooms: 1, finishingStatus: 'تشطيب كامل',       isCashOnly: false, cashDiscountPercentage:  6, originalContractPrice:  5500000, cashPaidToSeller:  825000, remainingInstallments:  4675000, monthlyEquivalentInstallment:  38958,  contractYear: 2024, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2026, coverImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=600', status: UnitStatus.PENDING_REVIEW },

    // ماونتن فيو – هايد بارك
    { title: 'تاون هاوس في هايد بارك – حديقة كبيرة',          sellerType: SellerType.DEVELOPER, developerId: devMountainView.id, projectId: projHydePark.id,    locationId: locTajammu.id,   unitTypeId: typeTownhouse.id,   area: 240, floor: null, bedrooms: 3, bathrooms: 3, finishingStatus: 'نصف تشطيب',       isCashOnly: false, cashDiscountPercentage: 10, originalContractPrice:  9500000, cashPaidToSeller:  950000, remainingInstallments:  8550000, monthlyEquivalentInstallment:  71250,  contractYear: 2024, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2027, coverImage: 'https://images.unsplash.com/photo-1449844908441-8829872d2607?q=80&w=600', status: UnitStatus.APPROVED },
    { title: 'فيلا مزدوجة في هايد بارك',                        sellerType: SellerType.DEVELOPER, developerId: devMountainView.id, projectId: projHydePark.id,    locationId: locTajammu.id,   unitTypeId: typeVilla.id,       area: 320, floor: null, bedrooms: 4, bathrooms: 4, finishingStatus: 'نصف تشطيب',       isCashOnly: false, cashDiscountPercentage: 11, originalContractPrice: 15000000, cashPaidToSeller: 2250000, remainingInstallments: 12750000, monthlyEquivalentInstallment: 106250,  contractYear: 2023, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2026, coverImage: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?q=80&w=600', status: UnitStatus.PENDING_REVIEW },

    // طلعت مصطفى – مدينتي
    { title: 'فيلا فاخرة في مدينتي',                             sellerType: SellerType.DEVELOPER, developerId: devTalaat.id,       projectId: projMadinaty.id,    locationId: locNasr.id,      unitTypeId: typeVilla.id,       area: 400, floor: null, bedrooms: 5, bathrooms: 5, finishingStatus: 'تشطيب كامل',       isCashOnly: false, cashDiscountPercentage: 15, originalContractPrice: 22000000, cashPaidToSeller: 3300000, remainingInstallments: 18700000, monthlyEquivalentInstallment: 155833,  contractYear: 2023, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2025, coverImage: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=600', status: UnitStatus.APPROVED },
    { title: 'شقة 2 غرف في مدينتي – تشطيب ممتاز',              sellerType: SellerType.DEVELOPER, developerId: devTalaat.id,       projectId: projMadinaty.id,    locationId: locNasr.id,      unitTypeId: typeApt.id,         area: 120, floor: 3,    bedrooms: 2, bathrooms: 2, finishingStatus: 'تشطيب كامل',       isCashOnly: false, cashDiscountPercentage: 10, originalContractPrice:  5500000, cashPaidToSeller:  825000, remainingInstallments:  4675000, monthlyEquivalentInstallment:  38958,  contractYear: 2024, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2025, coverImage: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=600', status: UnitStatus.APPROVED },

    // طلعت مصطفى – الرحاب
    { title: 'شقة في الرحاب – قريبة من الخدمات',                sellerType: SellerType.DEVELOPER, developerId: devTalaat.id,       projectId: projAlRehab.id,     locationId: locNewCairo.id,  unitTypeId: typeApt.id,         area: 140, floor: 2,    bedrooms: 3, bathrooms: 2, finishingStatus: 'تشطيب كامل',       isCashOnly: false, cashDiscountPercentage:  8, originalContractPrice:  6000000, cashPaidToSeller:  900000, remainingInstallments:  5100000, monthlyEquivalentInstallment:  42500,  contractYear: 2024, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2025, coverImage: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?q=80&w=600', status: UnitStatus.APPROVED },

    // بالم هيلز
    { title: 'فيلا في بالم باركس – إطلالة على الحديقة',         sellerType: SellerType.DEVELOPER, developerId: devPalmHills.id,    projectId: projPalmParks.id,   locationId: locZayed.id,     unitTypeId: typeVilla.id,       area: 350, floor: null, bedrooms: 4, bathrooms: 4, finishingStatus: 'نصف تشطيب',       isCashOnly: false, cashDiscountPercentage: 10, originalContractPrice: 17000000, cashPaidToSeller: 2550000, remainingInstallments: 14450000, monthlyEquivalentInstallment: 120416,  contractYear: 2024, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2027, coverImage: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?q=80&w=600', status: UnitStatus.APPROVED },

    // سيتي إيدج
    { title: 'شقة في ذا سيتي إيدج – تصميم عصري',               sellerType: SellerType.DEVELOPER, developerId: devCityEdge.id,     projectId: projCityEdge.id,    locationId: locAdm.id,       unitTypeId: typeApt.id,         area: 160, floor: 7,    bedrooms: 3, bathrooms: 2, finishingStatus: 'نصف تشطيب',       isCashOnly: false, cashDiscountPercentage:  9, originalContractPrice:  9000000, cashPaidToSeller: 1350000, remainingInstallments:  7650000, monthlyEquivalentInstallment:  63750,  contractYear: 2024, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2028, coverImage: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?q=80&w=600', status: UnitStatus.PENDING_REVIEW },

    // دامنهور – الإسكندرية
    { title: 'شقة مطلة على البحر – الإسكندرية',                 sellerType: SellerType.DEVELOPER, developerId: devDamnhour.id,     projectId: projAlexView.id,    locationId: locAlexandria.id, unitTypeId: typeApt.id,        area: 180, floor: 4,    bedrooms: 3, bathrooms: 2, finishingStatus: 'تشطيب كامل',       isCashOnly: false, cashDiscountPercentage:  7, originalContractPrice:  7500000, cashPaidToSeller: 1125000, remainingInstallments:  6375000, monthlyEquivalentInstallment:  53125,  contractYear: 2023, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2025, coverImage: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=600', status: UnitStatus.APPROVED },
  ];
  ...
  const individualUnits: any[] = [
    { title: 'شاليه فيو البحر في الجونة – لقطة كاش',            sellerType: SellerType.INDIVIDUAL, locationId: locGouna.id,      unitTypeId: typeChalet.id,       area: 120, floor: null, bedrooms: 2, bathrooms: 2, finishingStatus: 'تشطيب كامل', isCashOnly: true,  originalContractPrice: 0,        cashPaidToSeller: 5000000, remainingInstallments: 0,       monthlyEquivalentInstallment: 0,       contractYear: 2024, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2024, coverImage: 'https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?q=80&w=600', status: UnitStatus.APPROVED,      submittedByName: 'محمد أحمد',    submittedByPhone: '01012345678' },
    { title: 'شقة 3 غرف في مدينة نصر – تقسيط متبقي ممتاز',    sellerType: SellerType.INDIVIDUAL, locationId: locNasr.id,       unitTypeId: typeApt.id,          area: 160, floor: 4,    bedrooms: 3, bathrooms: 2, finishingStatus: 'تشطيب كامل', isCashOnly: false, cashDiscountPercentage: 5, originalContractPrice: 3000000, cashPaidToSeller:  800000, remainingInstallments: 2200000, monthlyEquivalentInstallment:  22916,  contractYear: 2022, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2023, coverImage: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?q=80&w=600', status: UnitStatus.APPROVED,      submittedByName: 'سارة محمود',   submittedByPhone: '01098765432' },
    { title: 'فيلا في الشيخ زايد – نصف تشطيب فرصة',           sellerType: SellerType.INDIVIDUAL, locationId: locZayed.id,      unitTypeId: typeVilla.id,        area: 300, floor: null, bedrooms: 4, bathrooms: 3, finishingStatus: 'نصف تشطيب',  isCashOnly: false, cashDiscountPercentage: 8, originalContractPrice: 9000000, cashPaidToSeller: 4000000, remainingInstallments: 5000000, monthlyEquivalentInstallment:  52083,  contractYear: 2021, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2023, coverImage: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?q=80&w=600', status: UnitStatus.APPROVED,      submittedByName: 'أحمد خالد',    submittedByPhone: '01155667788' },
    { title: 'دوبلكس في التجمع الخامس – عقد 2020',              sellerType: SellerType.INDIVIDUAL, locationId: locTajammu.id,    unitTypeId: typeDuplex.id,       area: 210, floor: 6,    bedrooms: 3, bathrooms: 3, finishingStatus: 'تشطيب كامل', isCashOnly: false, cashDiscountPercentage: 12, originalContractPrice: 6000000, cashPaidToSeller: 2500000, remainingInstallments: 3500000, monthlyEquivalentInstallment:  36458,  contractYear: 2020, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2023, coverImage: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=600', status: UnitStatus.APPROVED,      submittedByName: 'ياسمين علي',   submittedByPhone: '01223344556' },
    { title: 'شاليه في الساحل الشمالي – قابل للتفاوض',          sellerType: SellerType.INDIVIDUAL, locationId: locSahel.id,      unitTypeId: typeChalet.id,       area:  90, floor: null, bedrooms: 1, bathrooms: 1, finishingStatus: 'تشطيب كامل', isCashOnly: true,  originalContractPrice: 0,        cashPaidToSeller: 3500000, remainingInstallments: 0,       monthlyEquivalentInstallment: 0,       contractYear: 2023, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2024, coverImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=600', status: UnitStatus.APPROVED,      submittedByName: 'محمود سامي',   submittedByPhone: '01066778899' },
    { title: 'بنتهاوس في العاصمة – فرصة استثمارية نادرة',       sellerType: SellerType.INDIVIDUAL, locationId: locAdm.id,        unitTypeId: typePenthouse.id,    area: 260, floor: 10,   bedrooms: 4, bathrooms: 4, finishingStatus: 'سوبر لوكس',  isCashOnly: false, cashDiscountPercentage: 15, originalContractPrice: 14000000, cashPaidToSeller: 6000000, remainingInstallments: 8000000, monthlyEquivalentInstallment:  83333,  contractYear: 2023, deliveryStatus: DeliveryStatus.UNDER_CONSTRUCTION, deliveryYear: 2026, coverImage: 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?q=80&w=600', status: UnitStatus.PENDING_REVIEW, submittedByName: 'رنا عمر',      submittedByPhone: '01099887766' },
    { title: 'شقة في المعادي – هادئة ومميزة',                    sellerType: SellerType.INDIVIDUAL, locationId: locMaadi.id,      unitTypeId: typeApt.id,          area: 190, floor: 3,    bedrooms: 3, bathrooms: 2, finishingStatus: 'تشطيب كامل', isCashOnly: false, cashDiscountPercentage: 5,  originalContractPrice: 4000000, cashPaidToSeller: 1500000, remainingInstallments: 2500000, monthlyEquivalentInstallment:  26041,  contractYear: 2022, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2024, coverImage: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=600', status: UnitStatus.APPROVED,      submittedByName: 'كريم نبيل',    submittedByPhone: '01011223344' },
    { title: 'فيلا في الغردقة – إيجار سنوي مضمون',              sellerType: SellerType.INDIVIDUAL, locationId: locHurghada.id,   unitTypeId: typeVilla.id,        area: 270, floor: null, bedrooms: 4, bathrooms: 4, finishingStatus: 'تشطيب كامل', isCashOnly: true,  originalContractPrice: 0,        cashPaidToSeller: 8500000, remainingInstallments: 0,       monthlyEquivalentInstallment: 0,       contractYear: 2023, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2024, coverImage: 'https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?q=80&w=600', status: UnitStatus.APPROVED,      submittedByName: 'هبة مصطفى',    submittedByPhone: '01033445566' },
    { title: 'استوديو في الإسكندرية – للبيع أو الإيجار',         sellerType: SellerType.INDIVIDUAL, locationId: locAlexandria.id, unitTypeId: typeStudio.id,       area:  65, floor: 5,    bedrooms: 1, bathrooms: 1, finishingStatus: 'تشطيب كامل', isCashOnly: true,  originalContractPrice: 0,        cashPaidToSeller: 1800000, remainingInstallments: 0,       monthlyEquivalentInstallment: 0,       contractYear: 2024, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2024, coverImage: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?q=80&w=600', status: UnitStatus.PENDING_REVIEW, submittedByName: 'نور حسن',      submittedByPhone: '01077889900' },
    { title: 'شقة في القاهرة الجديدة – قريبة من الجامعة',       sellerType: SellerType.INDIVIDUAL, locationId: locNewCairo.id,   unitTypeId: typeApt.id,          area: 145, floor: 2,    bedrooms: 3, bathrooms: 2, finishingStatus: 'تشطيب جزئي', isCashOnly: false, cashDiscountPercentage: 6,  originalContractPrice: 5200000, cashPaidToSeller: 1800000, remainingInstallments: 3400000, monthlyEquivalentInstallment:  35416,  contractYear: 2022, deliveryStatus: DeliveryStatus.READY,              deliveryYear: 2024, coverImage: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=600', status: UnitStatus.APPROVED,      submittedByName: 'طارق إبراهيم', submittedByPhone: '01044556677' },
  ];
